      ...
      <div className='h-14 w-full border-b border-zinc-200 flex items-center justify-between px-2'>
        <div className='flex items-center gap-1.5'>
          <Button
            disabled={currPage <= 1}
            onClick={() => {
              {/*This code is a shorthand for a conditional statement.
           It subtracts 1 from the value "prev", but if the result is greater than 1, it returns that value. Otherwise, it returns 1.*/}
        ...
        <div className="space-x-2">
          ...
          <Button
            ...
            arial-aria-label="rotate 90 degrees" variant='ghost'>
        ...
        <SimpleBar autoHide={false} className="max-h-[calc(100vh-10rem)]">
          <div ref={ref} >
            <Document loading={
              ...
              onLoadError={() => {
                toast({
                  title: 'There is an Error loading this PDF',
